...
<el-input v-model="searchMap.ishot" placeholder="是否热门"></el-input></el-form-item>
  ...
  <el-dialog title="编辑" :visible.sync="dialogFormVisible">
    <el-form label-width="80px">
        ...
        <el-form-item label="企业简介"><el-input v-model="pojo.summary"></el-input></el-form-item>
        ...
        <el-form-item label="是否热门"><el-input v-model="pojo.ishot"></el-input></el-form-item>
