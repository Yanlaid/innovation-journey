...
import com.tensquare.recruit.dao.ArticleDao;
...
public class ArticleService {
    ...
    @Transactional
    public void reviewArticle(String articleId) {
        articleDao.reviewArticle(articleId, "1");
    }
     ...
     */
    @Transactional
    public void increaseTheNumberOfLike(String articleId) {
        articleDao.operateTheNumberOfLike(articleId, 1);
    }
}
