...
public class AdminService {
     ...
     * @return
     */
    public Admin login(Map loginMap) {
        Admin admin = adminDao.findByLoginname((String) loginMap.get("loginname"));
        if (admin == null) {
            return null;
        }
        if (bCryptPasswordEncoder.matches((String) loginMap.get("password"), admin.getPassword())) {
            return admin;
        }
        return null;
    }
